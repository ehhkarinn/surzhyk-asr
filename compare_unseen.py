...
dataset_dir = "/Users/karina/Desktop/university/whisper_dataset_unseen"
...
print("=== BASELINE WHISPER (unseen speakers) ===")
...
print("=== FINE-TUNED WHISPER (unseen speakers) ===")
try:
...
results = {
    ...
    "test_speakers": ["ANKU", "ANMO17"],
    "test_chunks": len(metadata)
}
with open("/Users/karina/Desktop/university/evaluation_unseen.json", "w") as f:
    json.dump(results, f, indent=2)
print("\nResults saved to evaluation_unseen.json")